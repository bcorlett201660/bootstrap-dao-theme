...
if($image_1_id){
  ...
  $img_1_thumb = wp_get_attachment_image_src($image_1_id, 'dao-theme-square-tiny');
...
if($image_2_id){
  ...
  $img_2_thumb = wp_get_attachment_image_src($image_2_id, 'dao-theme-square-tiny');
...
if($image_3_id){
  ...
  $img_3_thumb = wp_get_attachment_image_src($image_3_id, 'dao-theme-square-tiny');
...
if($image_4_id){
  ...
  $img_4_thumb = wp_get_attachment_image_src($image_4_id, 'dao-theme-square-tiny');
...
if($image_5_id){
  ...
  $img_5_thumb = wp_get_attachment_image_src($image_5_id, 'dao-theme-square-tiny');
...
if($image_6_id){
  ...
  $img_6_thumb = wp_get_attachment_image_src($image_6_id, 'dao-theme-square-tiny');
...
if($image_7_id){
  ...
  $img_7_thumb = wp_get_attachment_image_src($image_7_id, 'dao-theme-square-tiny');
...
if($image_8_id){
  ...
  $img_8_thumb = wp_get_attachment_image_src($image_8_id, 'dao-theme-square-tiny');
...
if($image_9_id){
  ...
  $img_9_thumb = wp_get_attachment_image_src($image_9_id, 'dao-theme-square-tiny');
...
if($image_10_id){
  ...
  $img_10_thumb = wp_get_attachment_image_src($image_10_id, 'dao-theme-square-tiny');
