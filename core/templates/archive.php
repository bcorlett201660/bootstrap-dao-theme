...
get_sidebar();
?> 
                <main id="main" class="col-md-<?php echo \BootstrapdaoTheme\Bootstrap4Utilities::getMainColumnSize(); ?> site-main" role="main">
                    <?php if (have_posts()) { ?> 
                    ...
                    <?php 
                        ...
                        $Bsb4Design = new \BootstrapdaoTheme\Bsb4Design();
